...
public class OompaExample {
    ...
    public static Oompa getFullExampleOompa() {

        return new Oompa(NAMES[0], AGES[0], JOBS[0], HEIGHTS[0], WEIGHTS[0], "sample text");
    }

    public static Oompa getFullExampleOompa(int index) {

        return new Oompa(NAMES[index], AGES[index], JOBS[index], HEIGHTS[index], WEIGHTS[index], "sample text");
    }
